...
12. {$plugin:toasterstats:Graph:geo:map:days:20:400:400}
    Export data and table view in piechart:
1. {$plugin:toasterstats:Graph:piechart:amount:product:days:20:400:450:table}
2. {$plugin:toasterstats:Graph:piechart:amount:type:days:20:400:450:table}
3. {$plugin:toasterstats:Graph:piechart:amount:customer:days:20:400:450:table}
4. {$plugin:toasterstats:Graph:piechart:amount:brand:days:20:400:450:table}
    Export data and table view in columnchart:
1. {$plugin:toasterstats:Graph:columnchart:count:tag:days:20:400:400:table}
2. {$plugin:toasterstats:Graph:columnchart:count:coupon:days:20:400:400:table}
3. {$plugin:toasterstats:Graph:columnchart:count:remarketing:days:20:400:450:all:table}
