...
parseInt(g,10):this.opt.targetText;0>this.opt.targetFormat.indexOf("{score}")&&b.error.call(this,'template "{score}" missing!');null!==a&&(g=this.opt.targetFormat.toString().replace("{score}",g));e.is(":input")?e.val(g):e.html(g)}},showHalf:function(a){var b=(a-Math.floor(a)).toFixed(1);0<b&&0.6>b&&this.stars.eq(Math.ceil(a)-1).attr("src",this.opt.path+this.opt.starHalf)},initialize:function(a){a=a?b.between(a,0,this.opt.number):0;b.fill.call(this,a);0<a&&(this.opt.halfShow&&b.roundStar.call(this,
...
$(function(){$(".starrating div.stars-container").each(function(){var d=!!$.cookie("pagerating"+$(this).data("pageid"));!0==$(this).data("readonly")&&(d=!0);$(this).raty({path:$("#website_url").val()+"plugins/pagerating/system/layout/images/",half:!0,readOnly:d,score:function(){return $(this).data("formid")?$.cookie("pagerating"+$(this).data("pageid")):$(this).data("score")},click:function(b,a){var c=this;$(this).data("formid")?($("#"+$(this).data("formid")).find('input[name="ratingValue"]').val(b),
$(this).raty("readOnly",!0)):$.post($("#website_url").val()+"plugin/pagerating/run/rating",{score:b,pageid:$(this).data("pageid")},function(a){a.error||($(c).raty("score",a.responseText.ratingValue),$(c).parent(".starrating").find(".ratingValue").text(a.responseText.ratingValue).end().find(".ratingCount").text(a.responseText.ratingCount),$(c).raty("readOnly",!0))},"json")}})});$("#starratingpostreview").on("click",function(d){d.preventDefault();d=$(this).closest("form").attr("id")+$("div.stars-container").attr("data-pageid");
$.post($("#website_url").val()+"plugin/pagerating/run/review",{ratingValue:$('.formrating input[name="score"]').val(),pageId:$("div.stars-container").attr("data-pageid"),name:$("#name").val(),author:$("#author").val(),email:$("#email").val(),description:$("#description").val(),"foo[id]":$("#foo-id").val(),"foo[input]":$("#foo-input").val(),recaptcha_challenge_field:$("#recaptcha_challenge_field").val(),recaptcha_response_field:$("#recaptcha_response_field").val(),purgen:$("#"+d).val()},function(b){1===
b.error?(Recaptcha.reload(),showMessage(b.responseText,1,5E3)):location.reload()},"json")})});
