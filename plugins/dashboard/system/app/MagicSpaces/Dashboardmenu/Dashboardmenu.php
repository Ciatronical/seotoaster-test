            ...
            foreach($nameOfHtml as $htmlFile){
                ...
                if($htmlFile !='' && $htmlFile != 'index'){
                    if($pageNavName == $htmlFile){
                        $preparedLink .= '<li><a href="'.$websiteUrl.'dashboard/'.$htmlFile.'/" class="current dashboard-link-'.$htmlFile.'">'.$translator->translate($htmlFile).'</a></li>';
                    }else{
                        $preparedLink .= '<li><a href="'.$websiteUrl.'dashboard/'.$htmlFile.'/" class="dashboard-link-'.$htmlFile.'">'.$translator->translate($htmlFile).'</a></li>';
                    }
                }
                if($htmlFile !='' && $htmlFile == 'index'){
                    if($pageNavName == 'dashboard'){
                        $preparedLink .= '<li><a href="'.$websiteUrl.'dashboard/" class="current dashboard-link-'.$htmlFile.'">'.$translator->translate($htmlFile).'</a></li>';
                    }else{
                        $preparedLink .= '<li><a href="'.$websiteUrl.'dashboard/" class="dashboard-link-'.$htmlFile.'">'.$translator->translate($htmlFile).'</a></li>';
                    }
                }
