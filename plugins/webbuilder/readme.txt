...
1. Directupload.
    ...
    Option "crop" support the width and height parameters.
    example: {$directupload:foldername:imagename:200:relgall:crop-200x100}.
    ...
    6. If you want to have default image displaying for not logged users. Upload image in folder plugins/webbuilder/web/images/placeholder.png.
...
6. Videolink
    This plugin is necessary for inserting videos on page.

    Using this plug-in you can add to your page video from next web-sites:
    ...
    How to do this:
    Add to container on page code of plugin, like this {$videolink:parameter_name} or for inline editing {$videolink:parameter_name:inline}.
    As 'parameter_name' write name for this 'embed code', for example 'demo'.
    It should look like {$videolink:demo}.
    Then on the page you will see the image. Click it.
    You will see the form, put in it link from the address bar of your browser, enter width and height, click 'Save' button.
